...
sealed class InteractionTrigger {
  ...
  /**
   * An interaction that was likely triggered by user input, i.e. either by a button click in the
   * UI or a hardware key press.
   *
   ...
   */
  object InputEvent : InteractionTrigger()
