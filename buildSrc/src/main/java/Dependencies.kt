object Versions {
   ...
   */
  val KotlinCompiler = System.getProperty("square.kotlinVersion") ?: "2.1.21"
...
object Dependencies {
  object Build {
    ...
    const val MavenPublish = "com.vanniktech:gradle-maven-publish-plugin:0.32.0"
    val Kotlin = "org.jetbrains.kotlin:kotlin-gradle-plugin:${Versions.KotlinCompiler}"
    const val Ktlint = "org.jlleitschuh.gradle:ktlint-gradle:12.3.0"
    const val AndroidXAnnotation = "androidx.annotation:annotation:1.1.0"
    const val BinaryCompatibility = "org.jetbrains.kotlinx:binary-compatibility-validator:0.18.1"
  ...
  const val AndroidXCore = "androidx.core:core:1.13.1"
